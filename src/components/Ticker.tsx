...
export default function Ticker({ usdtRate }: TickerProps) {
  ...
  return (
    <div className="w-full bg-blue-600 text-white py-1.5 px-4 overflow-hidden text-xs md:text-sm font-semibold select-none border-b border-blue-700/30 z-[49] relative">
      <div className="flex whitespace-nowrap animate-marquee">
        <span className="inline-block mx-8 font-mono">
          📊 <strong className="font-extrabold uppercase">COURS DU JOUR USDT/MGA :</strong> 1 USDT = <span className="bg-slate-950 text-blue-400 px-2 py-0.5 rounded font-black text-sm">{roundedRate} Ar</span> (Taux réel sur Internet mis à jour en direct 🟢)
        </span>
        ...
        <span className="inline-block mx-8 text-neutral-100">
        ...
        <span className="inline-block mx-8 text-neutral-105">
        ...
        <span className="inline-block mx-8 font-mono">
          📊 1 USDT = <strong className="bg-slate-950 text-blue-400 px-1.5 py-0.5 rounded font-black">{roundedRate} Ar</strong> (Internet Live Exchange 🟢)
        </span>
      </div>
    </div>
  );
